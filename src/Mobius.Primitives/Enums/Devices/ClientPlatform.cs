...
/// </summary>
public static class ClientPlatformEnumExtensions
{
    #region Platform
    ...
    public static SppWebApiCompatDevicePlatform ToPlatform(this ClientPlatform source)
    {
        ...
        {
            if (Platform_Windows.HasFlag(item)) result |= SppWebApiCompatDevicePlatform.Windows;
            if (Platform_Linux.HasFlag(item)) result |= SppWebApiCompatDevicePlatform.Linux;
            if (Platform_Android.HasFlag(item)) result |= SppWebApiCompatDevicePlatform.Android;
            if (Platform_Apple.HasFlag(item)) result |= SppWebApiCompatDevicePlatform.Apple;
            if (Platform_UWP.HasFlag(item)) result |= SppWebApiCompatDevicePlatform.UWP;
        }
        return result != default ? result : SppWebApiCompatDevicePlatform.Unknown;
    }
    ...
    public static ClientPlatform ToClientPlatform(this SppWebApiCompatDevicePlatform source)
    {
        ...
        foreach (var item in Enum2.FlagsSplit(source))
            result |= item switch
            {
                SppWebApiCompatDevicePlatform.Windows => Platform_Windows,
                SppWebApiCompatDevicePlatform.Linux => Platform_Linux,
                SppWebApiCompatDevicePlatform.Android => Platform_Android,
                SppWebApiCompatDevicePlatform.Apple => Platform_Apple,
                SppWebApiCompatDevicePlatform.UWP => Platform_UWP,
                _ => default
            };
        return result;
    }
