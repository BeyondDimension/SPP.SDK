namespace Mobius.Models.SteamBot;
...
public record SteamBotCommand
{
    ...
    public sealed record RemoveFriendCommand : SteamBotCommand
    {
        ...
        public ulong FriendSteamId => ulong.TryParse(DataId, out var parsedSteamId) ? parsedSteamId : 0;
    }
    ...
    public sealed record GenerateGiftCardPaymentQrCodeCommand : SteamBotCommand
    {
        ...
        public Guid RecordId => Guid.TryParse(DataId, out var parsedRecordId) ? parsedRecordId : Guid.Empty;
    }
}
